...
class NLLLoss(nn.Module):
    ...
    def forward(self, pred, data, weights=None):
        ...
        nll_pos, nll_neg, num_pos, num_neg = weight_loss(
            log_assignment, weights, gamma=self.conf.gamma_f    # 0
        )
        nll = (
    ...
    def nll_loss(self, log_assignment, data):
        ...
        positive = data["gt_assignment"].float()    # b,m,n
        neg0 = (data["gt_matches0"] == -1).float()  # b,m
        neg1 = (data["gt_matches1"] == -1).float()  # b,n
