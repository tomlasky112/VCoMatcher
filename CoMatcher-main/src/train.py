...
from src import __module_name__, logger
from src.datasets import get_dataset
from src.eval import run_benchmark
from src.models import get_model
from src.settings import EVAL_PATH, TRAINING_PATH
from src.utils.experiments import get_best_checkpoint, get_last_checkpoint, save_experiment
from src.utils.stdout_capturing import capture_outputs
...
if __name__ == "__main__":
    ...
    # copy src and submodule into output dir
